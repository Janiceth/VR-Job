...
adb pull /storage/extSdCard/mtklog mtklog
...
"C:\Program Files\2345Soft\HaoZip\HaoZipC.exe" a -tzip "C:\Users\Administrator\Desktop\mtklog_%date:~0,4%%date:~5,2%%date:~8,2%_%time:~0,2%%time:~3,2%%time:~6,2%.zip" mtklog\* anr\* device_info.txt vr.launcher_outlog.txt logcat.txt appmanager_outlog.txt bugreport.txt

RD /S /Q mtklog,anr >nul 2>nul
DEL /Q device_info.txt,appmanager_outlog.txt,vr.launcher_outlog.txt,logcat.txt,bugreport.txt >nul 2>nul